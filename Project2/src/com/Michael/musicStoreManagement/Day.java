...
public class Day implements Item {

	public String clockedIn(){return clockedIn;}

	public void setClockedIn(String clockedIn){this.clockedIn = clockedIn;}

	public ArrayList<Item> shippedToStore(){return shippedToStore;}

	public void setShippedToStore(ArrayList<Item> shippedToStore){this.shippedToStore = shippedToStore;}

	private String clockedIn = "";
	private ArrayList<Item> shippedToStore = new ArrayList<>();
