...
public enum ItemType {
    PAPERSCORE,CD,VINYL,GUITAR,BASS,MANDOLIN,FLUTE,HARMONICA,HAT,SHIRT,BANDANA,PRACTICEAMP,CABLE,STRINGS,SAXOPHONE,CASSETTE,CASSETTEPLAYER,GIGBAG,CDPLAYER,RECORDPLAYER,MP3;
}
